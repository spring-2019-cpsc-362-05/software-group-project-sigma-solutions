...
void mainMenu::on_startButton_clicked()
{
    ...
    qDebug() << "Controlled: " << control;
    qDebug() << "numDecks: " << numDecks;

    active = getPlayersActive();
    control = getPlayersUserControlled();
    numDecks = getNumberOfDecks();
...
void mainMenu::on_startingBankSpinBox_valueChanged(int arg1) { _startBank = arg1; }
